      ...
      <AppBar position="static">
        <Toolbar>
          ...
          >
                ...
                <img src="landingpage\src\components\images\alibaba-removebg-preview.png" alt="Alibaba.com" />
          ...
          <input type="submit" className="ui-searchbar-submit" value="Search"/>
...
<div style={{marginLeft:'16px'}}  id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img className="d-block w-100" src="https://s.alicdn.co`m/@img/imgextra/i2/O1CN01g9roWR1eePmq1CxIR_!!6000000003896-0-tps-990-400.jpg" alt="First slide"/>
    </div>
    <div className="carousel-item">
      <img className="d-block w-100" src="https://s.alicdn.com/@img/imgextra/i2/O1CN01g9roWR1eePmq1CxIR_!!6000000003896-0-tps-990-400.jpg" alt="Second slide"/>
    </div>
    <div className="carousel-item">
